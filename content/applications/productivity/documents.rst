...
split between two pages, click the :icon:`fa-scissors` (:guilabel:`scissors`) icon.
...
button and select the :guilabel:`Request` option. Add the :guilabel:`Document Name`, select the
...
.. tip::
   ...
   expecting a document. Go to the :guilabel:`Requested Document` column, click on the
   :icon:`fa-ellipsis-v` (:guilabel:`vertical ellipsis`) icon and
