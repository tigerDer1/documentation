...
easily readable and accessible on smaller screens. You can adjust this value by clicking the
...
To tailor the mobile view of your website, open the website editor, click the :icon:`fa-mobile`
(:guilabel:`mobile`) icon at the top, select an element of your building block, and go to the
:guilabel:`Customize` tab. There, you can edit the :ref:`Cols <building_blocks/cols>` and
:ref:`Visibility <building_blocks/visibility>` features without impacting the desktop view.
